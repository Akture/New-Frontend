    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-marble mb-6">
            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-ember to-red-400">Akture</span>
          </h1>
